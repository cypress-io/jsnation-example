...
/**
 * Instead of running the tests directly, run them on demand with a given viewport
 */
export const fullSpecTests = (viewport = 'macbook-15') => {
  expect(viewport).to.be.a('string')

  beforeEach(() => {
    // ignore conversion from a string to known viewport name
    // @ts-ignore
  ...
  describe(`TodoMVC on ${viewport}`, function () {
    beforeEach(function () {
